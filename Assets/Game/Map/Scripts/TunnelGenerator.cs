...
{
    /// <summary>Manages procedural 3D tunnel wall segments for the mining view.</summary>
    public class TunnelGenerator : MonoBehaviour
    {
        private static TunnelGenerator _instance;
        public static TunnelGenerator Instance => _instance;
