    ...
    public class LocalizationManager : MonoBehaviour
    {
        ...
        private void InitializeTranslations()
        {
            ...
            var en = new Dictionary<string, string>
            {
                ...
                { "event_merchant_title",            "Wandering Merchant" },
                { "event_merchant_desc",             "A weathered merchant appears from a side tunnel. What can he offer?" },
                { "event_merchant_hp_title",         "① Buy Ration (HP+3 / 3×Iron)" },
                { "event_merchant_hp_desc",          "A dried meal that restores 3 HP." },
                { "event_merchant_repair_title",     "② Repair service (Durability+20% / 2×Silver)" },
                { "event_merchant_repair_desc",      "The merchant patches up your pickaxe." },
                { "event_merchant_atk_title",        "③ Combat tonic (Attack+1 / 4×Gold)" },
                { "event_merchant_atk_desc",         "A potent brew that sharpens your strikes permanently." },
                { "event_merchant_leave_title",      "④ Leave" },
                { "event_merchant_leave_desc",       "Part ways with the merchant." },
            ...
            var ko = new Dictionary<string, string>
            {
                ...
                { "event_merchant_title",            "방랑 상인" },
                { "event_merchant_desc",             "낡은 상인이 옆 통로에서 나타났다. 무엇을 팔고 있을까?" },
                { "event_merchant_hp_title",         "① 식량 구매 (HP+3 / 철×3)" },
                { "event_merchant_hp_desc",          "건조 식량으로 3 HP를 회복한다." },
                { "event_merchant_repair_title",     "② 수리 서비스 (내구도+20% / 은×2)" },
                { "event_merchant_repair_desc",      "상인이 곡괭이를 수리해준다." },
                { "event_merchant_atk_title",        "③ 전투 강화제 (공격+1 / 금×4)" },
                { "event_merchant_atk_desc",         "영구적으로 공격력을 1 올리는 묘약." },
                { "event_merchant_leave_title",      "④ 그냥 떠나기" },
                { "event_merchant_leave_desc",       "상인과 작별하고 계속 내려간다." },
