    ...
    public static class AddressablesSetup
    {
        ...
        private static void GenerateEffectIconSprites()
        {
            var keys = new string[]
            {
                ...
                // 2026-08-25: CharacterID enum에는 10명이 있는데 위 3명만 등록돼 있었다 — 나머지 7명 추가.
                "Effect_CharacterPassive_Prisoner",
                "Effect_CharacterPassive_Adventurer",
                "Effect_CharacterPassive_Blacksmith",
                "Effect_CharacterPassive_Alchemist",
                "Effect_CharacterPassive_TreasureHunter",
                "Effect_CharacterPassive_Priest",
                "Effect_CharacterPassive_Berserker",
                // 2026-08-25: StartingRelicManager가 쓰는 시작 유물 아이콘(StartingRelic_*.asset 8종) — 등록 누락 상태였음.
                "Effect_StartingRelic_RustySword",
                "Effect_StartingRelic_MinerGloves",
                "Effect_StartingRelic_BloodPendant",
                "Effect_StartingRelic_HolyWater",
                "Effect_StartingRelic_LuckyCoin",
                "Effect_StartingRelic_SmallVial",
                "Effect_StartingRelic_Hammer",
                "Effect_StartingRelic_OldCompass",
                "Effect_Buff_Attack",
                "Effect_Buff_MaxHP",
